...
def parse_args():
    ...
    parser.add_argument("--mode", type=str, default="train", choices=["train", "generate", "compare"])
...
def train_models_compare(*, start: int | None = None, end: int | None = None, step: int = None, batch_size: int = 64, learning_rate: float = 1e-3 ):
...
def main():
    ...
    if args.mode == "train":
        ...
        train_models_compare(start=110, end=201, step=15)
